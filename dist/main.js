...
var AppController = function AppController(utils) {
    'ngInject';
...
var _app3 = require('./app.skinablescreen');
...
var AppTemplate = './app/app.template.html';

var AppDirective = function () {
    AppDirective.$inject = ["utils", "$http", "skinData", "$timeout"];
    function AppDirective(utils, $http, skinData, $timeout) {
        'ngInject';

        var _this = this;

        _classCallCheck(this, AppDirective);

        this.utils = utils;
        this.skinData = skinData;
        this.$timeout = $timeout;
        this.restrict = 'E';
        this.controller = _app2.default;
        this.controllerAs = '$ctrl';
        this.scope = {};
        this.templateUrl = AppTemplate;
        this.http = $http;
        this.link = function (scope) {
            return _this.linkFunc(scope);
        };
        this.loadedFiles = 0;
        this.totalNumber = 0;
        this.scpp;
    ...
    _createClass(AppDirective, [{
        key: 'linkFunc',
        value: function linkFunc(scope) {
            this.scpp = scope;
        ...
        value: function loadFile(path) {
            ...
            var content = this.http.get(path).then(function (result) {
                return _this2.successCallback(result);
            }, function (result) {
                return _this2.errorCallback(result);
            });
        }
    }, {
        key: 'successCallback',
        value: function successCallback(result, pth) {
        ...
        key: 'errorCallback',
        value: function errorCallback(resullt) {
            this.loadedFiles++;
            this.checkcompleteFileLoad();
        }
    }, {
        key: 'checkcompleteFileLoad',
        value: function checkcompleteFileLoad() {
        ...
        key: 'factory',
        value: ["utils", "$http", "skinData", "$timeout", function factory(utils, $http, skinData, $timeout) {
            'ngInject';
...
exports.default = AppDirective.factory;

},{"./app.controller":2,"./app.skinablescreen":6}],4:[function(require,module,exports){
'use strict';
...
var _app = require('./app.directive');
...
var _app5 = require('./app.skindataservice');
...
var _app7 = require('./app.skinablescreen');

var _app8 = _interopRequireDefault(_app7);

var _app9 = require('./app.skinelement');
...
var appmodule = angular.module('MainModule', []);

appmodule.directive('app', _app2.default);
appmodule.directive('skinablescreen', _app8.default);
appmodule.directive('skinelement', _app10.default);

appmodule.service('utils', _app4.default);
appmodule.service('skinData', _app6.default);

exports.default = appmodule.name;

},{"./app.directive":3,"./app.service":5,"./app.skinablescreen":6,"./app.skindataservice":7,"./app.skinelement":8,"jquery":1}],5:[function(require,module,exports){
"use strict";
...
var AppService = function () {
	...
	_createClass(AppService, [{
		key: "getXmlAsObject",
		value: function getXmlAsObject(str) {
		...
		key: "isPercentValue",
		value: function isPercentValue(strValue) {
			if (strValue != null) {
		...
		key: "convertPercentToNumeric",
		value: function convertPercentToNumeric(strPercent, fullValue) {
			var returnValue = 0;
...
var AppTemplate = './app/app.skinablescreen.html';

var SkinableScreen = function () {
    SkinableScreen.$inject = ["utils", "$http", "skinData"];
    function SkinableScreen(utils, $http, skinData) {
        'ngInject';

        var _this = this;

        _classCallCheck(this, SkinableScreen);
    ...
    _createClass(SkinableScreen, [{
        ...
        key: 'addElementToContainer',
        value: function addElementToContainer(objState) {
        ...
        key: 'filterStates',
        value: function filterStates(objToFilter) {
        ...
        key: 'validateState',
        value: function validateState(stateObj, stateValidated) {
        ...
        key: 'factory',
        value: ["utils", "$http", "skinData", function factory(utils, $http, skinData) {
            'ngInject';
    ...
    return SkinableScreen;
}();

exports.default = SkinableScreen.factory;

},{"./app.controller":2}],7:[function(require,module,exports){
"use strict";
...
var SkinDataService = function () {
	SkinDataService.$inject = ["$http"];
	function SkinDataService($http) {
		'ngInject';

		_classCallCheck(this, SkinDataService);
	...
	_createClass(SkinDataService, [{
		key: "saveFileData",
		value: function saveFileData(str, content) {
			this.data[str] = content;
		}
	}, {
		key: "getFileByPath",
		value: function getFileByPath(str) {
		...
		key: "getShapeStyleByName",
		value: function getShapeStyleByName(name) {
		...
		key: "getArrayByName",
		value: function getArrayByName(strname) {
		...
		key: "getCrtSkinProps",
		value: function getCrtSkinProps() {
			var skinobj = {};
			skinobj.width = 1280;
			skinobj.height = 1024;
	...
	return SkinDataService;
}();

exports.default = SkinDataService;
...
var AppTemplate = './app/app.skinelement.html';

var SkinElement = function () {
    SkinElement.$inject = ["utils", "$http", "skinData"];
    function SkinElement(utils, $http, skinData) {
        'ngInject';

        var _this = this;

        _classCallCheck(this, SkinElement);
        ...
        value: function linkFunc(scope) {
            ...
            if (this.generalProps.type == "Shape") {
                ...
                if (objStyle.shapeType == "circle") {
                    ...
                    if (objStyleorientation == "left") {} else if (objStyleorientation == "right") {} else if (objStyleorientation == "down") {} else {// else top 
                        //shape.rotation = 360;
                    }
                } else {
...
exports.default = SkinElement.factory;

},{"./app.controller":2}],9:[function(require,module,exports){
'use strict';
